...
public class CopperBlockBlock extends RotnBlocksModElements.ModElement {

	@ObjectHolder("rotn_blocks:copper_block")
	public static final Block block = null;

	public CopperBlockBlock(RotnBlocksModElements instance) {
		super(instance, 1);
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
...

			{
				...
				CopperBlockUpdateTickProcedure.executeProcedure($_dependencies);
			}
